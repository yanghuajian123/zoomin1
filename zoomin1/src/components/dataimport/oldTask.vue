<template>
  ...
  <!--编辑任务框-->
  <el-dialog title="编辑任务" :visible.sync="editDialogVisible" class="editDialog">
    <el-form ref="form" label-width="80px" label-position="left">
      <el-form-item label="任务名:">
        <el-input type="text" v-model="editDialog.taskName"></el-input>
      </el-form-item>
      <el-form-item label="创建时间:">
        <el-input type="text" disabled="false" v-model="editDialog.createTime"></el-input>
      </el-form-item>
      <el-form-item label="任务描述:">
        <el-input type="textarea" :rows="4" v-model="editDialog.taskDesc"></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    editTask(id){
      this.editTaskId = id;
      let query = this.$get("/taskinfo/" + id + "/");
      query.then(res =>{
        this.editDialog.taskName = res.task_name;
        this.editDialog.taskDesc = res.task_desc;
        this.editDialog.createTime = res.add_time.substring(0,10);
      });
