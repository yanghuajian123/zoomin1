<template>
  <div>
    <el-dialog title="辅助线设置" :visible.sync="dialogTableVisible" :modal-append-to-body="false">
      <div v-for="(item,index) in rowArray" :key="index">
        <MarkLineItem :selectOptions="selectOptions" @changeMsg="rowItemEvent" class="markLineStyle"></MarkLineItem>
      </div>
    ...
    <el-dialog title="数据标注" :modal-append-to-body="false" :visible.sync="chartDialogVisible" ref="dialog" @open="open()" id="chartDialog">
      <el-dialog
        width="30%"
