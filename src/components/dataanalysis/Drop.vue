          ...
          <div class="el-input el-input-group el-input-group--prepend">
            ...
            <div style="border-bottom: 1px solid #D0D0D0;min-height: 40px;text-align: left;margin-top:0px"
              ...
              <!-- <svg class="icon" aria-hidden="true" style="float:right;margin:10px" @click="addRowClick"
                   v-show="addIconFlag"> -->
                <i class="el-icon-plus"  aria-hidden="true" style="" @click="addRowClick"
                   v-show="addIconFlag"></i>
              <!-- </svg> -->
            </div>
          </div>
          ...
          <div style="border-bottom: 1px solid #D0D0D0;height: 40px;text-align: left;margin-top:0px"
            ...
            <!-- <svg class="icon" aria-hidden="true" style="float:right;margin:10px" @click="removeRowClick">
              <use xlink:href="el-icon-minus"></use>
                ...
                <i class="el-icon-minus"  aria-hidden="true" style="" @click="removeRowClick"
                   ></i>
          </div>
        </div>
      </el-row>
        ...
        <el-tab-pane label="计算方法" name="label1">
          ...
          <div style="margin:100px">
              <el-radio-group v-model="radio">
                  <el-radio label="求和" border>求和</el-radio>
                  <el-radio label="平均" border>平均</el-radio>
                  <el-radio label="计数" border>计数</el-radio>
              </el-radio-group>
            <!-- <el-radio v-model="radio" label="求和">求和</el-radio>
            <el-radio v-model="radio" label="平均">平均</el-radio>
            <el-radio v-model="radio" label="计数">计数</el-radio> -->
        ...
        <el-tab-pane label="排序方法" name="label2">
          ...
          <div style="margin:100px">
               <el-radio-group v-model="SortRadio">
                  <el-radio label="原序" border>原序</el-radio>
                  <el-radio label="升序" border>升序</el-radio>
                  <el-radio label="降序" border>降序</el-radio>
              </el-radio-group>
...
<script>
  import Bus from '../dataanalysis/vueBus'
...
.el-icon-plus,.el-icon-minus{
    color: $el-icon-plus-color;
    float:right;
    margin:10px;
    font-size: $el-icon-plus-size;
}
