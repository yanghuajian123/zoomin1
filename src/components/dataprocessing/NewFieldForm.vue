  ...
  <el-form ref="addFieldForm">
    ...
    <el-form-item>
      <el-input
        type="textarea"
        :rows="2"
        placeholder="根据下面函数提示编写expression"
        v-model="expression"
        resize="none"
      >
      </el-input>
      ...
      <el-row class="tac">
        <el-col :span="12">
          ...
          <vue-scroll :ops="ops">
            <div class='chooseFun'>
              <el-menu
                style="max-height:200px;border:0px"
              ...
              >
                ...
                >
                  <span slot="title">
                    <el-tooltip placement="top" hide-after="3000" transition="ease-in-out">
                      <div
                        slot="content"
                        style="font-size:16px"
                      >{{expression.affect}}<br />{{expression.example}}</div>
                      <a
                        style=""
                        type="text"
                        @click="addFunction(`${expression.name}`)"
                      >
                        <i class="el-icon-postcard"></i>{{expression.name}}
                      </a>
                    </el-tooltip>
                  </span>
                </el-menu-item>
