      ...
      <el-table-column align="center" prop="keyType" label="类型">
        <template slot-scope="scope">
          <span v-show="!showEdit">
            <svg class="icon" aria-hidden="true" style="margin-right:5px;width:15px;height:15px">
              <use :xlink:href="$utils.showTypesUi(scope.row.keyType)"></use>
            </svg>
            <!-- <img src="../../common/iconf/wenzi.svg" width="15px"> -->
...
import { TYPECONVERTER } from "../../utils/commonFunction";
export default {
  components: {
    TypeSelect
  },
